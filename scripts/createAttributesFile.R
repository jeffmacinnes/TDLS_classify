...
file <- read.csv(paste0('/projects/RRF13/TDLS_classify/data/', SUBID, '/', SUBID, '_trialOnsets.txt', sep=""), 
                  sep = "\t", header = TRUE)
...
write.table(final_attributes_stim, file=paste0('/projects/RRF13/TDLS_classify/data/', SUBID, '/', SUBID, '_attributes_stimuli.txt', sep=""),
            row.names=FALSE, col.names=FALSE, quote=FALSE)
